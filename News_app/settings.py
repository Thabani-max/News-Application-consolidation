...
SECRET_KEY = 'django-insecure-i!=%$764ocq5u&+pr)5y40368nz6w+8^7=m9o59^+la5u(i+r2'
...
AUTH_USER_MODEL = 'grabsomore.User'
...
STATICFILES_DIRS = [
    BASE_DIR / "eNews/static",
    BASE_DIR / "grabsomore/static",
]
...
# EMAIL_HOST_USER = 'your_email_address'                 # Your email address used to send mails
